...
<head>
  ...
  <title>Elegant Jewelry - Home</title>
...
<body>
  ...
  <footer class="bg-[#273639] text-white pt-16 pb-10 mt-20">
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
    
    <!-- Brand Column -->
    <div class="footer">
        <a href="/index" class="flex items-center">
          <img src="/uploads/manbhar logo.png" alt="Logo" class="h-20 w-auto -m-3 transition-transform">
        </a>
        <p class="pt-3">Jewels that fill the heart.</p>
    ...
    <div class="footer">
      ...
      <ul class="space-y-2">
        <li><a href="/index" class="hover:text-pink-600">Home</a></li>
        <li><a href="/collections" class="hover:text-pink-600">Collections</a></li>
    ...
    <div class="footer">
      ...
      <ul class="space-y-2">
        <li><a href="/services" class="hover:text-pink-600">Custom Jewelry</a></li>
        <li><a href="/services" class="hover:text-pink-600">CAD Designing</a></li>
        <li><a href="/services" class="hover:text-pink-600">CAM & Casting</a></li>
      </ul>
    </div>
    ...
    <div class="footer">
      ...
      <p class="mb-2">📞 +91 8852884944</p>
      <p class="mb-2">✉️ manbharcadjewellery22@gmail.com</p>
      <p>📍 840,Bagru Walo Ka Rasta,   Chandpole,302001-Jaipur,Rajasthan</p>
    </div>
  </div>

  <!-- Bottom Bar -->
  <div class="mt-10 border-t pt-6 text-center text-gray-500 text-xs">
    &copy; <?= date("Y") ?> Manbhar. All rights reserved.
  </div>
</footer>
